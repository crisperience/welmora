      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {results && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <Card
              className={`${results.supabase.success ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'} dark:bg-opacity-20`}
            >
              <CardHeader>
                ...
                <CardDescription>Database connection and authentication status</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card
              className={`${results.woocommerce.success ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'} dark:bg-opacity-20`}
            >
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                ...
                <CardDescription>WooCommerce REST API connection status</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  <p className="text-sm">
        ...
        <Card className="mt-8 max-w-4xl mx-auto">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <strong>WooCommerce Auth:</strong>
                <br />
                <code className="text-xs bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">
