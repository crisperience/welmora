        ...
        {scanResult && !scanLoading && (
          <Card className="mb-6">
            <CardContent className="p-4">
              ...
              <p
                className={`text-sm font-medium ${scanResult.startsWith('✅') ? 'text-green-600' : 'text-red-600'}`}
              >
                {scanResult}
              </p>
            </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <div className="text-sm text-gray-600 space-y-2">
              <p>
                <strong>Camera Scanner:</strong> Click &quot;Start Scanner&quot; to use your device
                camera to scan QR codes or barcodes.
              </p>
              <p>
                <strong>Manual Entry:</strong> Type or paste a code in the manual input field and
                click &quot;Test Scan&quot;.
              </p>
              <p>
                <strong>Quick Test:</strong> Use the predefined test codes to verify API
                functionality.
              </p>
              <p>
                <strong>Date Selection:</strong> Change the test date to match when orders were
                placed.
              </p>
            </div>
          </CardContent>
